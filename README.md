...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/fates-emerald-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fates-emerald-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add fates-emerald
# for installing globally
pixi global install fates-emerald
```
...
It is possible to list all of the versions of `fates-emerald` available on your platform:
...
```
pixi search fates-emerald --channel conda-forge
```
